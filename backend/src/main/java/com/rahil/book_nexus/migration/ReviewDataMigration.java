...
public class ReviewDataMigration implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Starting review data migration...");
        
        // Get all Google Book feedbacks
        ...
        for (GoogleBookFeedback googleFeedback : googleFeedbacks) {
            try {
                // Check if this feedback has already been migrated (avoid duplicates)
                ...
                // Copy audit fields manually since we can't use @CreatedDate
